  ...
  const onSubmit = async (values: z.infer<typeof PatientFormValidation>) => {
    ...
    try {
      const patient = {
        ...
        family_medical_history: values.familyMedicalHistory,
        ...
        identification_document: values.identificationDocument
          ? formData
          : undefined,
                  ...
                  >
                    {GenderOptions.map((option, i) => (
                      <div key={option + i} className="radio-group">
                        <RadioGroupItem value={option} id={option} className="border-2 border-dark-500 text-green-500 data-[state=checked]:border-green-500 data-[state=checked]:bg-green-500" />
